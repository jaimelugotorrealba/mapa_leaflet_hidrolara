...
<section class="container-fluid">
    <h1 class="block text-2xl font-semibold text-center mb-5">{{ __('Actualizar Bitácora') }}</h1>
    <form method="POST" action="{{  route('binnacles.update',['operability' => $operability->id]) }}"
        ...
        @endif
        @livewire('binnacle-component', ['operability' => $operability])
